...
public class Hammer extends BulkTool
{
	...
	public Hammer(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder)
	{
	...
	public float getDestroySpeed(ItemStack stack, BlockState state)
	{
		...
		return material != Material.METAL && material != Material.STONE ? super.getDestroySpeed(stack, state) : this.speed;
	}
}
